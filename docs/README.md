...
| 文档 | 当前版本 | 职责 |
| --- | --- | --- |
| `01-product-spec.md` | v0.5 | 产品定位、用户角色、核心概念、MVP 范围和验收标准 |
| `02-knowledge-lifecycle-spec.md` | v0.4 | 上传、解析、分块、检索、沉淀、评估的生命周期管理 |
| `03-system-architecture-spec.md` | v0.4 | 系统架构、模块边界、技术选型、数据流和扩展策略 |
