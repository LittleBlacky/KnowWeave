...
项目当前处于 Spec Coding 阶段，优先沉淀产品、生命周期、架构、数据模型和 ingestion 规格文档。代码实现应以后续 Spec 为准，不直接照搬参考项目代码。
...
1. [产品需求规格](docs/01-product-spec.md)
2. [知识生命周期规格](docs/02-knowledge-lifecycle-spec.md)
3. [系统架构规格](docs/03-system-architecture-spec.md)
4. [数据模型规格](docs/04-data-model-spec.md)
5. [Ingestion 规格](docs/05-ingestion-spec.md)
